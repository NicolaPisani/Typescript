...
function identity<Type>(value: Type): Type { // Rendo la funzione `identity` generica.
  return value;
}
...
let user = await fetchData<User>("http://api.com/user/1"); // Passo `User` come argomento di tipo.
