...
interface CountryWithPopulation extends Country { // Estendo l'interfaccia `Country` con `extends`
  population: number; // e aggiungo la proprietà `population` con il tipo appropriato.
}
