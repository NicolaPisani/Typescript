...
type CountryWithLanguages = Country & CountryLanguages; // Use intersection type
...
type CountryWithStatistics = Country & CountryStatistics; // Create the intersection type
